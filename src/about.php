			...
			<div class="row align-items-center justify-content-between d-flex">
				...
				<nav id="nav-menu-container">
					<ul class="nav-menu">
						...
						<li class="menu-active" ><a href="../index.php" class="list">accueil</a></li>
						<li><a href="about.php" class="list">À propos de nous</a></li>
...
<div style="height: 20px; width: 100%; background: black;" > </div>
